...
class FluxControlOursPipeline(
    ...
    def prepare_image_with_mask(
        ...
        masks = masks.repeat(1, foreground_image_latents.shape[1], 1, 1)
        ...
        control_image = torch.cat([image_latents, foreground_image_latents, masks], dim=1) # bs, 16+16+16=48, h, w
